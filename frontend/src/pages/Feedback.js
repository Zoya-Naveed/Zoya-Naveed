...
function Feedback() {
  ...
  return (
    ...
    {error ? (
      ...
      <div className='rating-container' style={{ height: submit ? '0px' : 'auto' }}>
        {submit ? (
          <p style={{ fontWeight: 'bold', fontSize: '24px' }}>Thank you for providing feedback!</p>
        ) : (
          <>
            ...
            <div className="buttons-container">
              <button className={rated && rating > 0 && categorySelected && opinion ? 'submit active' : 'submit'} 
              onClick={onSubmit} disabled={!rated || rating === 0 || !categorySelected || !opinion}>Submit</button>
